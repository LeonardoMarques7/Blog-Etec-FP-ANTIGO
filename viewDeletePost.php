    ...
    <div class="container">
        <main id="posts-container">
            ...
            <form name="produto" action="deletePost.php" class="form border rounded shadow-lg" method="post" enctype="multipart/form-data"><br><br>
                ...
                <div class="col text-start">
                    <b>Título do Post:</b><br><input class="form-control border-primary" placeholder="Digite o Título" type="text"  name="titulo" id="titulo" maxlength="80" title="Digite o Título" value="<?php echo $dados['titulo'];?>" readonly>
                </div><br>
                <div class="col text-start">
                    <b>Assuno do Post:</b><br><textarea class="form-control border-primary" placeholder="Digite o Novo Assunto do Post" name="assunto" id="assunto" readonly><?php echo $dados['assunto'];?></textarea>
                </div><br>
                <div class="col text-start">
                    <b>Autor do Post:</b><br><input class="form-control border-primary" placeholder="Digite o Autor" type="text" name="autor" id="autor" required title="Digite o Autor" value="<?php echo $dados['autor'];?>" readonly></input>
                </div><br>
                <div class="col text-start">
                    <b>Link do Post:</b><br><input class="form-control border-primary" placeholder="Digite o Link" type="text" name="link" id="link" title="Digite o Link" value="<?php echo $dados['link'];?>" readonly></input>
                </div><br>
                <div class="col text-start">
                    <b>Data de Cadastra:</b><br><input class="form-control text-center border-primary" name="datePost" id="datePost" type="datetime-local" required title="Digite data do Post" value="<?php echo $dados['datePost'];?>" readonly></input>
                </div><br>
