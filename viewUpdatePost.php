        ...
        <main id="posts-container">
            ...
            <form name="produto"  style="padding: 50px; padding-top: 0px;" action="alterarPost.php" class="form border rounded shadow-lg" method="post" enctype="multipart/form-data"><br><br>
                ...
                <div class="col text-start d-none">
                    <b>Assunto ATUAL: </b><br><div class="form-control"><?php echo $dados['assunto'];?></div>
                </div><br>
                <div class="col text-start">
                    <b>Assuno do Post:</b><br><textarea name="assunto" id="assunto" class="form-control" value='<?php echo $dados['assunto'];?>'><?php echo $dados['assunto'];?></textarea><br>
                ...
                <div class="col text-start">
                    <b>Link do Post:</b><br><input class="form-control border-primary" placeholder="Digite o Link" type="text" name="link" id="link" title="Digite o Link" value="<?php echo $dados['link'];?>"></input>
                </div><br>
                <div class="col text-start">
